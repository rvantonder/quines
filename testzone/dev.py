...
def fs(): print "let pl = "+t2(c);print "let py = "+t2(p);print "let fs = "+t2(f);print "let ls = "+t2(l);print "let cc = "+t2(s);print ''.join([chr(x) for x in f])
...
| _ -> t3 "let pl = [|" pl; t3 "let py = [|" py; t3 "let fs = [|" fs; t3 "let ls = [|" ls; t3 "let cc = [|" cc; printfn "%s" <| t4 fs
